...
public class AcornItemSettings extends Item.Settings {
    ...
    public AcornItemSettings hitSound(SoundEvent soundEvent) {
        this.component(AcornComponents.HIT_SOUND, new HitSoundComponent(soundEvent.getId(), false));
        return this;
    }

    public AcornItemSettings hitSound(SoundEvent soundEvent, boolean randomPitch) {
        this.component(AcornComponents.HIT_SOUND, new HitSoundComponent(soundEvent.getId(), randomPitch));
        return this;
    }
