...
public class AcornLangGen extends OrganizedLanguageProvider {
    ...
    public void generateTexts(RegistryWrapper.WrapperLookup registries, TranslationBuilder builder) {
        // Plush Descriptions
        builder.add(ACO_PLUSH.getTranslationKey() + ".desc", "Blue Hoodie");
        builder.add(CHEM_PLUSH.getTranslationKey() + ".desc", "Only $9.99!");
        builder.add(CLOWN_ACO_PLUSH.getTranslationKey() + ".desc", "Clown");
        builder.add(FESTIVE_ACO_PLUSH.getTranslationKey() + ".desc", "Festive");
        builder.add(KIO_PLUSH.getTranslationKey() + ".desc", "Pointless Words, Sharp Swords.");
        builder.add(TOAST_PLUSH.getTranslationKey() + ".desc", "Mrrew :3");
