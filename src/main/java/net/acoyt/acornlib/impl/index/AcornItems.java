...
public interface AcornItems {
    ...
    @Nullable Item TEST_ITEM = createDev("test_item", TestItem::new, new Item.Settings()
            .component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true));
    ...
    static @Nullable Item createCompat(String name, String modId, Function<Item.Settings, Item> factory, Item.Settings settings) {
    ...
    static @Nullable Item createDev(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
