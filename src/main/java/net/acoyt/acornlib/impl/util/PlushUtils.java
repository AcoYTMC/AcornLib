...
public class PlushUtils {
    ...
    public static Block getPlushBlock(ItemStack stack) {
        ...
        if (stack.isIn(AcornItemTags.PLUSHIES)) {
    ...
    public static Item getPlushItem(Block block) {
        ...
        return block.getDefaultState().isIn(AcornBlockTags.PLUSHIES) ? block.asItem() : item.get(); // Gets the block as an item, if it's a plushie.
    }
