package net.acoyt.acornlib.util.supporter.impl;
...
public abstract class SupporterImpl {
        ...
        try {
            ...
            if (connection.getResponseCode() == 200) {
                ...
                if (jsonObject.has("players") && jsonObject.get("players").isJsonArray()) {
                    ...
                    AcornLib.LOGGER.error("Error: 'players' field is missing or not an array for " + getId());
                }
                reader.close();
            } else {
